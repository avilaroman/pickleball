...
## Finaliza el ejemplo de comentario generado al ingresar un archivo de video, además del conteo de botes y la adhesión del minimapa con el rastreo de los jugadores y la pelota.
Contribuciones

# Te interesa Contribuir al Proyecto?
...
Informa de los errores en https://github.com/avilaroman/pickleball/issues.
...
https://github.com/avilaroman/pickleball/issues.
...
son bienvenidas :) Saludos mundo del Pickle!
